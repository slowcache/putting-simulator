...
impl Ball {
    ...
    pub fn is_able_to_fall_in_hole(&self) -> bool {
    ...
    pub fn move_ball_and_collide(&mut self, walls: &Vec<Wall>) {
        ...
        for w in walls.iter() {
            ...
            // This will collide early in most cases, and still allows for the ball to phase through walls in extreme cases
            // Accepting PRs for fixing phasing through the wall
